...
namespace Student_Result_Management_System.Controllers
{
    ...
    public class SinhVienController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] int? khoaId, [FromQuery] int? lopHocPhanId) // async go with Task<> to make function asynchronous
        {
            List<SinhVien> sinhViens = await _sinhVienService.GetFilteredSinhViensAsync(khoaId, lopHocPhanId);
